...
# Revisions:
#       Date          Author       Reason
#       06/01/13      Y Chen       Created on app04 for getting estofs_18z model run
#
# Abstract:
#       Script run from cron to set date parameters and launch estofs-scp.sh (core ESTOFS
#       retrieval script)
#
# Program Execution:  estofs_18z.sh
#
# Input Parameters:
#
...
$TOOLSDIR/terminators/clone_terminator.sh estofs_18z.sh
